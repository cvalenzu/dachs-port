...
<!-- ********************* generic datalink procs -->
	...
	<procDef type="descriptorGenerator" id="fromStandardPubDID">
		...
		<deprecated>
			Using deprecated //datalink#fromStandardPubDID proc
			This will go away with version 1.0.
			Please change source to use //soda#fromStandardPubDID now.
		</deprecated>
		<code>
	...
	<procDef type="dataFormatter" id="trivialFormatter">
		...
		<deprecated>
			Using deprecated //datalink#trivialFormatter proc
			This will go away with version 1.0.
			Please change source to use //soda#trivialFormatter now.
		</deprecated>
	...
	<procDef type="dataFunction" id="generateProduct">
		...
		<deprecated>
			Using deprecated //datalink#generateProduct proc
			This will go away with version 1.0.
			Please change source to use //soda#generateProduct.
		</deprecated>
	...
	<procDef type="descriptorGenerator" id="sdm_genDesc">
		...
		<deprecated>
			Using deprecated //datalink#sdm_genDesc proc
			This will go away with version 1.0.
			Please change source to use //soda#sdm_genDesc now.
		</deprecated>
	...
	<procDef type="dataFunction" id="sdm_genData">
		...
		<deprecated>
			Using deprecated //datalink#sdm_genData proc
			This will go away with version 1.0.
			Please change source to use //soda#sdm_genData now.
		</deprecated>
	...
	<procDef type="descriptorGenerator" id="fits_genDesc">
		...
		<deprecated>
			Using deprecated //datalink#fits_genDesc proc
			This will go away with version 1.0.
			Please change source to use //soda#fits_genDesc now.

			Also, use the opportunity to set the new accrefPrefix
			parameter.
		</deprecated>
	...
	<procDef type="metaMaker" id="fits_makeWCSParams">
		...
		<deprecated>
			Using deprecated //datalink#fits_makeWCSParams proc
			This will go away with version 1.0.
			Please change source to use the //soda# equivalent.  You probably
			want to use the //soda#fits_standardDLFuncs STREAM.
		</deprecated>
	...
	<procDef type="dataFunction" id="fits_makeHDUList">
		...
		<deprecated>
			Using deprecated //datalink#fits_makeHDUList proc
			This will go away with version 1.0.
			Please change source to use the //soda# equivalent.  You probably
			want to use the //soda#fits_standardDLFuncs STREAM.
		</deprecated>
	...
	<procDef type="dataFunction" id="fits_doWCSCutout">
		...
		<deprecated>
			Using deprecated //datalink#fits_doWCSCutout proc
			This will go away with version 1.0.
			Please change source to use the //soda# equivalent.  You probably
			want to use the //soda#fits_standardDLFuncs STREAM.
		</deprecated>
	...
	<procDef type="dataFormatter" id="fits_formatHDUs">
		...
		<deprecated>
			Using deprecated //datalink#fits_dataFormatter proc
			This will go away with version 1.0.
			Please change source to use the //soda# equivalent.  You probably
			want to use the //soda#fits_standardDLFuncs STREAM.
		</deprecated>
	...
	<procDef type="metaMaker" id="fits_makeLambdaMeta">
		...
		<deprecated>
			Using deprecated //datalink#fits_makeLambdaMeta proc
			This will go away with version 1.0.
			Please change source to use //soda#fits_makeBANDMeta or
			use the //soda#fits_standardDLFuncs STREAM.
		</deprecated>
	...
	<procDef type="dataFunction" id="fits_makeLambdaSlice">
		...
		<deprecated>
			Using deprecated //datalink#fits_makeLambdaSlice proc
			This will go away with version 1.0.
			Please change source to use the //soda#fits_makeBANDSlice,
			or just use the //soda#fits_standardDLFuncs STREAM.
		</deprecated>
